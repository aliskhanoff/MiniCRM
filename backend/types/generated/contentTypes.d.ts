...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    HouseName: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiClientContactsClientContacts extends Struct.CollectionTypeSchema {
  collectionName: 'client_contact';
  info: {
    displayName: 'Contacts';
    pluralName: 'client-contact';
    singularName: 'client-contacts';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    company: Schema.Attribute.Relation<'manyToOne', 'api::companies.companies'>;
    contact_type: Schema.Attribute.Relation<'oneToOne', 'api::contact-types.contact-types'>;
    ContactIcon: Schema.Attribute.String;
    ContactValue: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::client-contacts.client-contacts'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiClientMachineClientMachine extends Struct.CollectionTypeSchema {
  collectionName: 'client_machines';
  info: {
    displayName: 'ClientMachines';
    pluralName: 'client-machines';
    singularName: 'client-machine';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    company: Schema.Attribute.Relation<'oneToOne', 'api::companies.companies'>;
    ContractFile: Schema.Attribute.Media<'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    DeliveryDate: Schema.Attribute.DateTime;
    gambling_machine: Schema.Attribute.Relation<
      'oneToOne',
      'api::gambling-machine.gambling-machine'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::client-machine.client-machine'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiClientsClients extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BTWNumber: Schema.Attribute.String;
    client_contacts: Schema.Attribute.Relation<'oneToMany', 'api::client-contacts.client-contacts'>;
    ClientPhoto: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    companies: Schema.Attribute.Relation<'oneToMany', 'api::companies.companies'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    FullName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::clients.clients'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCompaniesCompanies extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    company_contacts: Schema.Attribute.Relation<
      'oneToMany',
      'api::client-contacts.client-contacts'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::companies.companies'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    owner: Schema.Attribute.Relation<'manyToOne', 'api::clients.clients'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiContactTypesContactTypes extends Struct.CollectionTypeSchema {
  collectionName: 'contact_type';
  info: {
    displayName: 'ContactTypes';
    pluralName: 'contact-type';
    singularName: 'contact-types';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ContactType: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::contact-types.contact-types'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiGamblinMachinesSupplierGamblinMachinesSupplier
  extends Struct.CollectionTypeSchema {
  collectionName: 'gamblin_machines_suppliers';
  info: {
    displayName: 'GamblinMachinesSuppliers';
    pluralName: 'gamblin-machines-suppliers';
    singularName: 'gamblin-machines-supplier';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gamblin-machines-supplier.gamblin-machines-supplier'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGamblingMachineBrandsGamblingMachineBrands extends Struct.CollectionTypeSchema {
  collectionName: 'gambling_machine_brand';
  info: {
    displayName: 'GamblingMachineBrands';
    pluralName: 'gambling-machine-brand';
    singularName: 'gambling-machine-brands';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gambling-machine-brands.gambling-machine-brands'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGamblingMachineTypeGamblingMachineType extends Struct.CollectionTypeSchema {
  collectionName: 'gambling_machine_types';
  info: {
    displayName: 'GamblingMachineType';
    pluralName: 'gambling-machine-types';
    singularName: 'gambling-machine-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gambling-machine-type.gambling-machine-type'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiGamblingMachineGamblingMachine extends Struct.CollectionTypeSchema {
  collectionName: 'gambling_machines';
  info: {
    displayName: 'GamblingMachines';
    pluralName: 'gambling-machines';
    singularName: 'gambling-machine';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    LicenceNumber: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gambling-machine.gambling-machine'
    ...
    supplier: Schema.Attribute.Relation<
      'oneToOne',
      'api::gamblin-machines-supplier.gamblin-machines-supplier'
    >;
    type: Schema.Attribute.Relation<'oneToOne', 'api::gambling-machine-type.gambling-machine-type'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}

export interface ApiPositionsPositions extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::positions.positions'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::client-contacts.client-contacts': ApiClientContactsClientContacts;
      'api::client-machine.client-machine': ApiClientMachineClientMachine;
      'api::clients.clients': ApiClientsClients;
      'api::companies.companies': ApiCompaniesCompanies;
      'api::contact-types.contact-types': ApiContactTypesContactTypes;
      'api::country.country': ApiCountryCountry;
      'api::gamblin-machines-supplier.gamblin-machines-supplier': ApiGamblinMachinesSupplierGamblinMachinesSupplier;
      'api::gambling-machine-brands.gambling-machine-brands': ApiGamblingMachineBrandsGamblingMachineBrands;
      'api::gambling-machine-type.gambling-machine-type': ApiGamblingMachineTypeGamblingMachineType;
      'api::gambling-machine.gambling-machine': ApiGamblingMachineGamblingMachine;
      'api::positions.positions': ApiPositionsPositions;
