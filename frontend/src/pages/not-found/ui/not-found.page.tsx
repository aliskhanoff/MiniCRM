...
export const NotFound: React.FC = () => {
  return (
    <div className="p-4 h-screen w-full flex flex-col items-center justify-center bg-white dark:bg-gray-900">
      <h1 className="text-5xl font-bold mb-4 uppercase">404 - Page Not Found</h1>

      <svg
        className="w-auto max-w-[30rem] h-auto text-gray-800 dark:text-white"
        aria-hidden="true"
        width="433"
        height="559"
        viewBox="0 0 433 559"
      ...
      >
        ...
        <path
          ...
          clip-rule="evenodd"
          d="M168.025 452.826L184.978 389.558L186.909 390.076L169.957 453.344L168.025 452.826Z"
          fill="url(#paint0_linear_275_1035)"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
        ...
        <path
          ...
          clip-rule="evenodd"
          d="M214.384 396.738L215.459 398.425L178.777 421.802L198.856 460.388L197.082 461.311L176.157 421.1L214.384 396.738Z"
          fill="url(#paint1_linear_275_1035)"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
        ...
        <path
          ...
          clip-rule="evenodd"
          d="M157.853 381.591L156.079 382.514L176.158 421.1L139.476 444.477L140.551 446.164L178.778 421.802L157.853 381.591Z"
          fill="url(#paint2_linear_275_1035)"
        />
        <rect
          x="175.032"
          y="411.222"
        ...
        <rect
          ...
          rx="2"
          transform="rotate(15 175.032 411.222)"
          fill="url(#paint3_linear_275_1035)"
        />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
        ...
        <path
          d="M149.336 352.573C179.995 353.968 209.986 362.004 237.235 376.125L234.864 378.144C227.673 384.265 222.514 392.428 220.07 401.549L151.489 383.173C153.933 374.052 153.546 364.403 150.38 355.506L149.336 352.573Z"
          fill="url(#paint5_linear_275_1035)"
        />
        <rect
          width="44"
          height="69"
        ...
        <rect
          ...
          height="69"
          transform="matrix(-0.965926 -0.258819 -0.258819 0.965926 232.294 467.976)"
          fill="url(#paint6_linear_275_1035)"
        />
        <rect
          x="112.52"
          y="435.883"
